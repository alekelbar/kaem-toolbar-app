...
import { ClockContext, ClockContextType } from './context/ClockContext';
...
export const Settings = () => {
  ...
  return (
    <Stack sx={{ margin: '0 auto', width: '100%', color: 'white' }}>
      <Typography gutterBottom>{clockContext?.work} Minutos de estudio</Typography>
      <PrettoSlider
        size={'medium'}
      ...
      <Typography gutterBottom>{clockContext?.rest} Minutos de descanso</Typography>
      <PrettoSlider
        size={'medium'}
        valueLabelDisplay="auto"
        aria-label="pretto slider"
      ...
      <Button
        onClick={() => { clockContext?.reset() }}
        variant='contained' sx={{ margin: '20px auto' }}>
